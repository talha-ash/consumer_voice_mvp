...
config :consumer_voice_mvp, ConsumerVoiceMvp.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "consumer_voice_mvp_dev",
  stacktrace: true,
...
config :consumer_voice_mvp, ConsumerVoiceMvpWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:consumer_voice_mvp, ~w(--sourcemap=inline --watch)]},
...
config :consumer_voice_mvp, ConsumerVoiceMvpWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/consumer_voice_mvp_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :consumer_voice_mvp, dev_routes: true
